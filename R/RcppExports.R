...
.adaptspec <- function(nLoop, nWarmUp, nSegmentsMax, xR, tMin, sigmaSquaredAlpha, tauPriorA, tauPriorB, tauUpperLimit, probMM1, nBases, nSegmentsStart = 1L, showProgress = FALSE) {
    .Call('BayesSpec_adaptspec', PACKAGE = 'BayesSpec', nLoop, nWarmUp, nSegmentsMax, xR, tMin, sigmaSquaredAlpha, tauPriorA, tauPriorB, tauUpperLimit, probMM1, nBases, nSegmentsStart, showProgress)
}
