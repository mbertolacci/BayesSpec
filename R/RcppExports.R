...
.adaptspec <- function(nLoop, nWarmUp, xR, missingIndicesR, priorList, probMM1, varInflate, burnInVarInflate, startR, thin, showProgress) {
...
.lsbp_mixture <- function(nLoop, nWarmUp, xR, missingIndicesR, designMatrixR, priorsR, priorMeanR, priorPrecisionR, tauPriorASquared, tauPriorNu, probMM1, varInflate, burnInVarInflate, firstCategoryFixed, nSplineBases, startR, thin, showProgress, mpi) {
    .Call('_BayesSpec_logisticStickBreakingMixture', PACKAGE = 'BayesSpec', nLoop, nWarmUp, xR, missingIndicesR, designMatrixR, priorsR, priorMeanR, priorPrecisionR, tauPriorASquared, tauPriorNu, probMM1, varInflate, burnInVarInflate, firstCategoryFixed, nSplineBases, startR, thin, showProgress, mpi)
}
