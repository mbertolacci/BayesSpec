...
.adaptspec <- function(nLoop, nWarmUp, xR, missingIndicesR, priorList, probMM1, varInflate, burnInVarInflate, nSegmentsStart, thin, showProgress) {
    .Call('_BayesSpec_adaptspec', PACKAGE = 'BayesSpec', nLoop, nWarmUp, xR, missingIndicesR, priorList, probMM1, varInflate, burnInVarInflate, nSegmentsStart, thin, showProgress)
}
